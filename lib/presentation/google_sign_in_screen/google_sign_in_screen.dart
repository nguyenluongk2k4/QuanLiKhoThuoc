...
class _GoogleSignInScreenState extends State<GoogleSignInScreen>
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 2.h),
          Text(
            'Secure access to your pharmaceutical inventory system with real-time synchronization across all devices.',
          ...
          Row(
            ...
            children: [
              _buildFeatureItem('QR Scanning', 'qr_code_scanner'),
              _buildFeatureItem('Real-time Sync', 'sync'),
              _buildFeatureItem('Secure Access', 'verified_user'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildFeatureItem(String label, String iconName) {
    return Column(
      children: [
        CustomIconWidget(
          iconName: iconName,
  ...
  Widget _buildTrustIndicators() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        _buildTrustBadge('SSL Secured', 'https'),
        SizedBox(width: 4.w),
        _buildTrustBadge('HIPAA Compliant', 'verified'),
        SizedBox(width: 4.w),
        _buildTrustBadge('Firebase Protected', 'cloud_done'),
      ],
    );
  }
